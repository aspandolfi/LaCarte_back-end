...
var RdbmsSchemaBuilder = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        _c.sent();
                        _c.label = 7;
                    case 7: return [4 /*yield*/, this.queryRunner.commitTransaction()];
                    case 8:
                        _c.sent();
                        return [3 /*break*/, 16];
                    case 9:
                    ...
                    case 14: return [4 /*yield*/, this.queryRunner.release()];
                    case 15:
                        _c.sent();
                        return [7 /*endfinally*/];
    ...
    RdbmsSchemaBuilder.prototype.executeSchemaSyncOperationsInProperOrder = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryRunner.createSchema()];
                    case 1:
                        _a.sent();
                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (foreignKeySchemasToDrop.length === 0)
                                            return [2 /*return*/];
                                        this.connection.logger.logSchemaBuild("dropping old foreign keys of " + tableSchema.name + ": " + foreignKeySchemasToDrop.map(function (dbForeignKey) { return dbForeignKey.name; }).join(", "));
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        tableSchema = new TableSchema_1.TableSchema(metadata.tableName, this.metadataColumnsToColumnSchemas(metadata.columns), true, metadata.engine);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        // drop all indices that point to this column
                        _a.sent();
                        this.connection.logger.logSchemaBuild("columns dropped in " + tableSchema.name + ": " + droppedColumnSchemas.map(function (column) { return column.name; }).join(", "));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!tableSchema)
                            return [2 /*return*/];
                        updatedColumnSchemas = tableSchema.findChangedColumns(this.connection.driver, metadata.columns);
                        if (updatedColumnSchemas.length === 0)
                            return [2 /*return*/];
                        this.connection.logger.logSchemaBuild("columns changed in " + tableSchema.name + ". updating: " + updatedColumnSchemas.map(function (column) { return column.name; }).join(", "));
                    ...
                    case 2:
                        ...
                        newAndOldColumnSchemas = updatedColumnSchemas.map(function (changedColumnSchema) {
                            ...
                            var newColumnSchema = ColumnSchema_1.ColumnSchema.create(columnMetadata, _this.connection.driver.normalizeType(columnMetadata), _this.connection.driver.normalizeDefault(columnMetadata));
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (addedKeys.length === 0 && droppedKeys.length === 0)
                            return [2 /*return*/];
                        this.connection.logger.logSchemaBuild("primary keys of " + tableSchema.name + " has changed: dropped - " + (droppedKeys.map(function (key) { return key.columnName; }).join(", ") || "nothing") + "; added - " + (addedKeys.map(function (key) { return key.columnName; }).join(", ") || "nothing"));
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        dropQueries = tableSchema.indices
                            ...
                            var metadataIndex = metadata.indices.find(function (indexMetadata) { return indexMetadata.name === indexSchema.name; });
                            if (!metadataIndex)
                                return true;
                            ...
                            if (metadataIndex.columns.length !== indexSchema.columnNames.length)
                                return true;
                            if (metadataIndex.columns.findIndex(function (col, i) { return col.databaseName !== indexSchema.columnNames[i]; }) !== -1)
                                return true;
                            return false;
                        })
    ...
    RdbmsSchemaBuilder.prototype.dropColumnReferencedIndices = function (tableName, columnName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        allIndexMetadatas = this.connection.entityMetadatas.reduce(function (all, metadata) { return all.concat(metadata.indices); }, []);
     ...
     */
    RdbmsSchemaBuilder.prototype.metadataColumnsToColumnSchemas = function (columns) {
        var _this = this;
        return columns.map(function (columnMetadata) {
            return ColumnSchema_1.ColumnSchema.create(columnMetadata, _this.connection.driver.normalizeType(columnMetadata), _this.connection.driver.normalizeDefault(columnMetadata));
        });
    };
