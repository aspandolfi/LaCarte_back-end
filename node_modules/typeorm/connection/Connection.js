...
var Connection = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        if (!(this.options.dropSchema || this.options.dropSchemaOnConnection)) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.dropDatabase()];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7:
                        if (!(this.options.synchronize || this.options.autoSchemaSync)) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.synchronize()];
                    case 8:
                        _a.sent();
                        _a.label = 9;
                    case 9:
                        if (!(this.options.migrationsRun || this.options.autoMigrationsRun)) return [3 /*break*/, 11];
    ...
    Connection.prototype.createQueryRunner = function (mode) {
        ...
        var manager = new EntityManagerFactory_1.EntityManagerFactory().create(this, queryRunner);
