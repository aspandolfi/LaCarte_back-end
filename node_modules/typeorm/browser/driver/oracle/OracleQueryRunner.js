...
var OracleQueryRunner = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, dbTables.map(function (dbTable) {
                                ...
                                tableSchema.primaryKeys = constraints
                                    ...
                                    return new PrimaryKeySchema(constraint["CONSTRAINT_NAME"], constraint["COLUMN_NAME"]);
                                });
                                ...
                                tableSchema.foreignKeys = constraints
                                    ...
                                    .map(function (constraint) { return new ForeignKeySchema(constraint["CONSTRAINT_NAME"], [], [], "", ""); }); // todo: fix missing params
     ...
     */
    OracleQueryRunner.prototype.createSchema = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        ...
                        sql = "ALTER TABLE \"" + tableSchema.name + "\" MODIFY \"" + newColumn.name + "\" " + this.connection.driver.createFullType(newColumn) + " " + (newColumn.isNullable ? "NULL" : "NOT NULL");
                        return [4 /*yield*/, this.query(sql)];
                    case 11:
                        _a.sent();
                        return [3 /*break*/, 14];
                    case 12:
                        ...
                        sql = "ALTER TABLE \"" + tableSchema.name + "\" MODIFY \"" + newColumn.name + "\" " + this.connection.driver.createFullType(newColumn);
                        return [4 /*yield*/, this.query(sql)];
                    case 13:
                        _a.sent();
                        _a.label = 14;
    ...
    Object.defineProperty(OracleQueryRunner.prototype, "dbName", {
         ...
         */
        get: function () {
            return (this.driver.options.schema || this.driver.options.schemaName);
        },
        enumerable: true,
        configurable: true
    });
