...
var PostgresQueryRunner = /** @class */ (function () {
     ...
     */
    PostgresQueryRunner.prototype.insert = function (tableName, keyValues) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, dbTables.map(function (dbTable) {
                                var tableSchema = new TableSchema(dbTable["table_name"]);
                                // create column schemas from the loaded columns
                                tableSchema.columns = dbColumns
                                    .filter(function (dbColumn) { return dbColumn["table_name"] === tableSchema.name; })
                                    .map(function (dbColumn) {
                                    var isGenerated = dbColumn["column_default"] === "nextval('" + dbColumn["table_name"] + "_" + dbColumn["column_name"] + "_seq'::regclass)"
                                    ...
                                    if (columnSchema.type === "array") {
                                        ...
                                        columnSchema.type = _this.connection.driver.normalizeType({ type: type });
                                    }
                                ...
                                tableSchema.primaryKeys = primaryKeys
                                    ...
                                    .map(function (primaryKey) { return new PrimaryKeySchema(primaryKey["constraint_name"], primaryKey["column_name"]); });
     ...
     */
    PostgresQueryRunner.prototype.createSchema = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 18:
                        ...
                        _a.label = 19;
                    case 19:
                        if (!(newColumn.default !== oldColumn.default)) return [3 /*break*/, 23];
                        if (!(newColumn.default !== null && newColumn.default !== undefined)) return [3 /*break*/, 21];
                        return [4 /*yield*/, this.query("ALTER TABLE \"" + tableSchema.name + "\" ALTER COLUMN \"" + newColumn.name + "\" SET DEFAULT " + newColumn.default)];
                    case 20:
                        _a.sent();
                        return [3 /*break*/, 23];
                    case 21:
                        if (!(oldColumn.default !== null && oldColumn.default !== undefined)) return [3 /*break*/, 23];
                        return [4 /*yield*/, this.query("ALTER TABLE \"" + tableSchema.name + "\" ALTER COLUMN \"" + newColumn.name + "\" DROP DEFAULT")];
                    case 22:
                        _a.sent();
                        _a.label = 23;
    ...
    PostgresQueryRunner.prototype.dropColumn = function (table, column) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.query("ALTER TABLE \"" + table.name + "\" DROP \"" + column.name + "\"")];
            });
        });
    };
    /**
    ...
    Object.defineProperty(PostgresQueryRunner.prototype, "schemaName", {
        /**
