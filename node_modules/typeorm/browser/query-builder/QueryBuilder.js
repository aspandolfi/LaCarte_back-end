...
var QueryBuilder = /** @class */ (function () {
     ...
     */
    QueryBuilder.prototype.relation = function (entityTarget, propertyPath) {
    ...
    QueryBuilder.prototype.createQueryBuilder = function () {
        return new this.constructor(this.connection);
    };
    /**
    ...
    QueryBuilder.prototype.createFromAlias = function (entityTarget, aliasName) {
        ...
        if (this.connection.hasMetadata(entityTarget)) {
            ...
            return this.expressionMap.createAlias({
                name: aliasName,
                tableName: isSubQuery === false ? entityTarget : undefined,
