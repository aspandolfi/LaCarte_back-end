...
var MigrationExecutor = /** @class */ (function () {
    ...
    MigrationExecutor.prototype.executePendingMigrations = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var executedMigrations, lastTimeExecutedMigration, allMigrations, pendingMigrations, transactionStartedByUs, err_1, rollbackError_1;
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, PromiseUtils.runInSequence(pendingMigrations, function (migration) {
                                return migration.instance.up(_this.queryRunner)
                                    .then(function () {
    ...
    MigrationExecutor.prototype.undoLastMigration = function () {
        return __awaiter(this, void 0, void 0, function () {
            var executedMigrations, lastTimeExecutedMigration, allMigrations, migrationToRevert, transactionStartedByUs, err_2, rollbackError_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // create migrations table if its not created yet
                    ...
                    case 4:
                        _a.trys.push([4, 9, , 14]);
                        return [4 /*yield*/, migrationToRevert.instance.down(this.queryRunner)];
                    case 5:
                        _a.sent();
    ...
    MigrationExecutor.prototype.createMigrationsTableIfNotExist = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.queryRunner.hasTable("migrations")];
                    case 1:
                        tableExist = _a.sent();
                        if (!!tableExist) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.queryRunner.createTable(new TableSchema("migrations", [
                                new ColumnSchema({
                                    name: "timestamp",
    ...
    MigrationExecutor.prototype.insertExecutedMigration = function (migration) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.connection.driver instanceof SqlServerDriver)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.queryRunner.insert("migrations", {
                                timestamp: new MssqlParameter(migration.timestamp, this.connection.driver.normalizeType({ type: this.connection.driver.mappedDataTypes.migrationTimestamp })),
                                name: new MssqlParameter(migration.name, this.connection.driver.normalizeType({ type: this.connection.driver.mappedDataTypes.migrationName })),
                            })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.queryRunner.insert("migrations", {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.connection.driver instanceof SqlServerDriver)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.queryRunner.delete("migrations", {
                                timestamp: new MssqlParameter(migration.timestamp, this.connection.driver.normalizeType({ type: this.connection.driver.mappedDataTypes.migrationTimestamp })),
                                name: new MssqlParameter(migration.name, this.connection.driver.normalizeType({ type: this.connection.driver.mappedDataTypes.migrationName })),
                            })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.queryRunner.delete("migrations", {
                            timestamp: migration.timestamp,
                            name: migration.name,
                        })];
                    case 3:
