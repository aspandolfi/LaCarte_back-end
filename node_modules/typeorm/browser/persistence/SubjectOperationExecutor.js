            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.queryRunner.insert(parentEntityMetadata.tableName, parentValuesMap)];
                    case 1:
                        ...
                        return [4 /*yield*/, this.queryRunner.insert(metadata.tableName, childValuesMap)];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.queryRunner.insert(metadata.tableName, valuesMap)];
                    case 4:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        promises = junctionInsert.junctionEntities.map(function (newBindEntity) {
                            ...
                            return _this.queryRunner.insert(relation.junctionEntityMetadata.tableName, OrmUtils.zipObject(columns, values));
                        });
                        return [4 /*yield*/, Promise.all(promises)];
                    case 1:
                        _a.sent();
