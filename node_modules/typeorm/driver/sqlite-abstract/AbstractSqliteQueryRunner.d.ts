...
export declare class AbstractSqliteQueryRunner implements QueryRunner {
    ...
    protected recreateTable(tableSchema: TableSchema, oldTableSchema?: TableSchema, migrateData?: boolean): Promise<void>;
    /**
     * If given value is a table name then it loads its table schema representation from the database.
     */
    protected getTableSchema(tableSchemaOrName: TableSchema | string): Promise<TableSchema>;
}
