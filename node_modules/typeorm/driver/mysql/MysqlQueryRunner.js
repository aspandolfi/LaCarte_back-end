                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            tableSchema.indices = dbIndices
                                                ...
                                                return new IndexSchema_1.IndexSchema(dbTable["TABLE_NAME"], dbIndexName, columnNames, currentDbIndices[0]["NON_UNIQUE"] === 0);
                                            })
    ...
    MysqlQueryRunner.prototype.hasTable = function (table) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tableName = table instanceof TableSchema_1.TableSchema ? table.name : table;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tableName = table instanceof TableSchema_1.TableSchema ? table.name : table;
                        columnName = column instanceof ColumnSchema_1.ColumnSchema ? column.name : column;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tableName = table instanceof TableSchema_1.TableSchema ? table.name : table;
                        indexName = index instanceof IndexSchema_1.IndexSchema ? index.name : index;
                        sql = "ALTER TABLE `" + tableName + "` DROP INDEX `" + indexName + "`";
                        if (!(index instanceof IndexSchema_1.IndexSchema)) return [3 /*break*/, 2];
                        columns = index.columnNames.map(function (columnName) { return "`" + columnName + "`"; }).join(", ");
