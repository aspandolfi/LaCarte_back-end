...
var SelectQueryBuilder = /** @class */ (function (_super) {
    ...
    SelectQueryBuilder.prototype.createSelectExpression = function () {
        ...
        var froms = this.expressionMap.aliases
            .filter(function (alias) { return alias.tableName || alias.subQuery; })
            .map(function (alias) {
            if (alias.subQuery)
                return alias.subQuery + " " + _this.escape(alias.name);
            return _this.escape(alias.tableName) + " " + _this.escape(alias.name);
        });
    ...
    SelectQueryBuilder.prototype.buildEscapedEntityColumnSelects = function (aliasName, metadata) {
        ...
        var columns = hasMainAlias ? metadata.columns.filter(function (column) { return column.isSelect === true; }) : metadata.columns.filter(function (column) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (metadata.hasMultiplePrimaryKeys) {
                            if (this.connection.driver instanceof SqliteDriver_1.SqliteDriver) {
